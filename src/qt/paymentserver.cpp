...
const char* BIP71_MIMETYPE_PAYMENT = "application/fifacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/fifacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/fifacoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start fifacoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("fifacoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'fifacoin://' is not a valid URI. Use 'fifacoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Fifacoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
