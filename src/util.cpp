...
const char * const BITCOIN_CONF_FILENAME = "fifacoin.conf";
const char * const BITCOIN_PID_FILENAME = "fifacoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fifacoin";
#else
    // Unix
