...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.fifacoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.fifacointools.com");
        vSeeds.emplace_back("dnsseed.fifacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.fifacointools.com");
        vSeeds.emplace_back("seed-b.fifacoin.loshan.co.uk");
