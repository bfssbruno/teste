...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fifacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fifacoin-tx [options] <hex-tx> [commands]  Update hex-encoded fifacoin transaction\n" +
            "or:     fifacoin-tx [options] -create [commands]   Create hex-encoded fifacoin transaction\n" +
            "\n";
