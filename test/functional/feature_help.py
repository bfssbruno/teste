...
"""Verify that starting fifacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fifacoin with -h for help text")
        ...
        self.log.info("Start fifacoin with -version for version information")
        ...
        self.log.info("Start fifacoind with -fakearg to make sure it does not start")
