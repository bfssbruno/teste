# Support for Output Descriptors in Fifacoin Core

Since Fifacoin Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `ffc1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Fifacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fifacoin Core wallets, a convenience function `combo` is
