...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../fifacoin/contrib/gitian-keys/README.md`.
...
space *do not upload these to the fifacoin.org server, nor put them in the torrent*.
