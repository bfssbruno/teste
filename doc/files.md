...
* fifacoin.conf: contains configuration settings for fifacoind or fifacoin-qt
* fifacoind.pid: stores the process id of fifacoind while running
...
* debug.log: contains debug information and general logging generated by fifacoind or fifacoin-qt
